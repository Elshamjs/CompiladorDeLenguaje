...
namespace CompiladorDeLenguaje.Structures.StructOperations
{
    ...
    {
        public StructCompareOperation(DataField value1, DataField value2, string operatorSS) : base(OperationType.Compare, DATA_TYPE.BINARIO)
        {
            Value1 = value1;
            Value2 = value2;
        ...
        {
            return new PrimitiveVariable<bool>((bool)StructOperation.evaluateOperation(OperatorSS, Value1.VariableValue, Value2.VariableValue), "000");
        }
    }
}
